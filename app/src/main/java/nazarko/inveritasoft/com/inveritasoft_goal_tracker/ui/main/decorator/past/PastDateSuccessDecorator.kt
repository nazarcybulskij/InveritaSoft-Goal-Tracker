 ...
 */
class PastDateSuccessDecorator(var context: Context, val goalsMap:HashMap<CalendarDay,Goal>) : DayViewDecorator {
    ...
    override fun shouldDecorate(day: CalendarDay?): Boolean {
        ...
        return  todayBoolean  && goalsMap.get(day)?.iscomment == false
    }
