 ...
 */
class TodayDateFailDecorator(var context: Context, val goalsMap:HashMap<CalendarDay,Goal> ) : DayViewDecorator {
    ...
    init{
        ...
        finalDrawable = LayerDrawable(arrayOf(drawable,todaydrawable)).mutate()
    }

    override fun shouldDecorate(day: CalendarDay?): Boolean {
        return today.equals(day!!)  && goalsMap.get(day)?.result == ResultDay.FAIL
